...
const MockDashboard = () => {
  ...
  // Static data
  const stats = { clients: 3, programs: 2 };
  const recentClients = [
    { id: 1, full_name: "John Doe", date_of_birth: "1990-01-15", contact: "john@example.com" },
    { id: 2, full_name: "Jane Smith", date_of_birth: "1985-05-22", contact: "jane@example.com" },
    { id: 3, full_name: "Mike Johnson", date_of_birth: "1978-11-30", contact: "mike@example.com" }
  ];
    ...
    {/* NAVBAR */}
      ...
      <div className="container">
        <div className="dashboard-header">
          <h1>Welcome to Clinix Health Management System</h1>
          <p>A comprehensive platform for managing client health records, program enrollments, and personalized care services.</p>
        </div>
        ...
        <div className="section">
          <div className="section-header">
            ...
            <Link to="/mockclients" className="primary-button">View Sample Clients</Link>
          </div>
            ...
            {recentClients.map(client => (
              <li key={client.id} className="client-card card">
                ...
                <div className="client-details">
                  <p>Date of Birth: {new Date(client.date_of_birth).toLocaleDateString()}</p>
        ...
        <div className="section">
          <div className="section-header">
            ...
            <Link to="/mockprograms" className="primary-button">View Example Programs</Link>
          </div>
          <ul className="cards-list">
